...
Welcome to the [Alias Quick Switcher](https://github.com/mnaoumov/obsidian-alias-quick-switcher/) demo vault. This plugin adds a quick switcher that resolves aliases in **every** segment of a path, not only in the note at the end of it — so a folder you renamed in your head, and a note you call something else, can both be typed the way you think of them.
